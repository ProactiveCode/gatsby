			...
			<div className={Styles.headerWrap}>
				...
				<div className={Styles.innerHeaderWrap}>
					<div className={Styles.socials}>
						<a href="https://www.facebook.com/digitalenagency/" target="_blank" className={Styles.link}>
						...
						<a href="https://www.instagram.com/proactive_code/" target="_blank" className={Styles.link}>
						...
						<a href="https://www.linkedin.com/company/proactive-code/" target="_blank" className={Styles.link}>
							<svg version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 300 300">
